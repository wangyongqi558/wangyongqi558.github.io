...
<div style="text-align: center;">
  <img src="/images/aaai24_tsne.png" alt="T-SNE Visualization" style="width: 60%; max-width: 500px; border-radius: 8px;">
  <p style="color: #666; font-size: 0.9em;">Figure: T-SNE visualization of predicate features.</p>
</div>
